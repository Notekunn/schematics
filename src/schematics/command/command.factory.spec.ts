...
describe('CommandFactory', () => {
  ...
  it('should create a command in a subfolder', async () => {
    ...
    const commandFile = files.find((file) => file == '/src/modules/users/cqrs/commands/impl/create-user.command.ts')
    const handlerFile = files.find((file) => file == '/src/modules/users/cqrs/commands/handler/create-user.handler.ts')
